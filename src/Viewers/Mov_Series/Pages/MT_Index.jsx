                  ...
                  <div className="desc_cont_wrapper">
                    ...
                    <div className="desc_title_head"> 
                      <div className="title_header">
                        ...
                        <span className="title_year">
                            {
                                type() == "Manga" 
                                ? getYear(published?.from) 
                                : type() == "Anime"
                                ? getYear(aired?.from)
                                : type() == "Movies"
                                ? getYear(aired)
                      ...
                      <div className="desc_info_wrap">
                        ...
                        <div className="fullYearRelease_info">
                            {
                            type() == "Manga" ? formatYear(published?.from) 
                            : type() == "Anime"
                            ? formatYear(aired?.from)
                            : type() == "Movies"
                            ? formatYear(aired)
                            : formatYear(aired)
                            } {`(JP)`}
